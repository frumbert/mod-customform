...
/**
 * Define all the restore steps that will be used by the restore_customform_activity_task
 */

/**
 * Structure step to restore one page activity
 */
class restore_customform_activity_structure_step extends restore_activity_structure_step {

    protected function define_structure() {

        $paths = array();
        $paths[] = new restore_path_element('customform', '/activity/customform');
    ...
    protected function process_page($data) {
        ...
        $newitemid = $DB->insert_record('customform', $data);
